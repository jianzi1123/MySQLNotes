...
 mysql> SELECT * FROM fruits WHERE f_name REGEXP 'ba{1,3}';mysql
...
| MySQL的目录结构                             | 说明                                 | 路径                                       |
| ------------------------------------------- | ------------------------------------ | ------------------------------------------ |
| bin目录                                     | 所有MySQL的可执行文件。如：mysql.exe | D:\MySQL\MySQL  Server 8.0                 |
| MySQLInstanceConfig.exe                     | 数据库的配置向导，在安装时出现的内容 |                                            |
| data目录                                    | 系统数据库所在的目录                 | C:\ProgramData\MySQL\MySQL Server 8.0\Data |
| my.ini文件                                  | MySQL的主要配置文件                  | C:\ProgramData\MySQL\MySQL Server 8.0      |
